...
private
  ...
  def create_transaction(p_amount, p_descriptption,p_balance, p_id)
    Transaction.create(amount: p_amount, description: p_description,
    balance_after_transaction: p_new_balance, account_id: p_id)
  end
